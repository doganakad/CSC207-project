...
public class Itinerary implements Serializable{
    private static final long serialVersionUID = 8641290543930198286L;
    ...
    public String toUIString() {
        return "Itinerary from " + this.getOrigin() + " to "
                + this.getDestination() + ", with "
                + this.flights.length + " flight(s)."
                + "\nTravel Time: " + this.totalTime
                + "\nCost: $" + this.totalCost;
    }
     ...
     * @return flights of this Itinerary
     */
    ...
    /**
     * Returns true iff this itinerary is full
