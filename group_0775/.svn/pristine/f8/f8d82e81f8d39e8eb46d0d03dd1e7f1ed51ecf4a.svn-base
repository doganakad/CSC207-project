...
public class Driver {
	...
	public static void uploadFlightInfo(String path) {
		BookingApp.loadFlightsList(path);
	}
	...
	public static String getFlights(String date, String origin, String destination) {
		return BookingApp.displayTimeFlights(BookingApp.searchFlights(date, origin, destination));
	}
	...
	public static String getItineraries(String date, String origin, String destination) {
		return BookingApp.displayTimeItineraries(BookingApp.searchItineraries(date, origin, destination));
	}
	...
	public static String getItinerariesSortedByCost(String date, String origin, String destination) {
		return BookingApp.displayCostItineraries(BookingApp.searchItineraries(date, origin, destination));
	}
