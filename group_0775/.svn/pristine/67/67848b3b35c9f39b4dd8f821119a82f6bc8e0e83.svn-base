...
public class User {
	 ...
	 * email email, address address, and its credit card no creditCardNumber.
	 * 
	 * @param lastName
	...
	/**
	 * Returns the information about the client with the given email.
	 * 
	 * @return a String representing the stored client information
	 */
	...
	public void uploadUsersInfo(String clientFileName) {
		BookingApp.loadUsersList(clientFileName);
	}
